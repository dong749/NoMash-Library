  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        ...
        <li v-for="famousWorks in allFamousWorks" :key="famousWorks">
          {{ famousWorks }}
        </li>
      </ul>
      ...
      <ul>
        <li v-for="famousWorks in austen.famousWorks" :key="famousWorks">
          {{ famousWorks.title }}
        </li>
      </ul>
    </section>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(value, key) in bookstores.openingHours" :key="key">
          {{ key }}: Open from {{ value.open }} to {{ value.close }}
        </li>
      </ul>
